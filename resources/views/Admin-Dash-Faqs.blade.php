        ...
        <div class="row">
            <div class="col-xl-2 col-md-3">
                <div class="sideBar">
                    ...
                    <div id="menus">
                        ...
                        <a class="active" href="faqs"><i class="fas fa-question"></i><span>Add
                                FAQs</span></a>
                        <a href="about"><i class="fas fa-info"></i><span>Edit About</span></a>
            ...
            <div class="col">
                <div class="DashContainer">
                    <div class="row">
                        <h3 style="color: #095256; text-align:center;margin: 1em 0em;">Add FAQ's</h3>

                        <form action="faqs/insert" method="post" return="false"
                    ...
                    <div class="row">
                        <h3 style="color: #095256; text-align:center;margin: 1em 0em;">FAQ's</h3>
